...
class AppTextStyles {
  ...
  static TextStyle get buttonText =>
      _base(size: 14, weight: FontWeight.w600, color: Colors.white);
  static TextStyle get priceText =>
      _base(size: 16, weight: FontWeight.w700, color: AppColors.primaryDeep);
  static TextStyle get oldPriceText =>
      _base(size: 12, color: AppColors.textHint)
          .copyWith(decoration: TextDecoration.lineThrough);
  static TextStyle get categoryLabel =>
      _base(size: 12, weight: FontWeight.w600);
  static TextStyle get ratingText =>
      _base(size: 12, weight: FontWeight.w600, color: AppColors.ratingYellow);
  static TextStyle get hintText => _base(size: 14, color: AppColors.textHint);
  static TextStyle get linkText =>
      _base(size: 14, weight: FontWeight.w600, color: AppColors.primaryColor);
  static TextStyle get badgeText =>
      _base(size: 10, weight: FontWeight.w600, color: Colors.white);
  static TextStyle get timerText =>
      _base(size: 14, weight: FontWeight.w700, color: Colors.white);
  static TextStyle get discountText =>
      _base(size: 11, weight: FontWeight.w700, color: Colors.white);
  static TextStyle get promoTitle =>
      _base(size: 20, weight: FontWeight.w700, color: Colors.white);
  static TextStyle get promoSubtitle =>
      _base(size: 12, color: const Color(0xB3FFFFFF));
  static TextStyle get navLabelActive =>
      _base(size: 11, weight: FontWeight.w600, color: AppColors.primaryColor);
  static TextStyle get navLabelInactive =>
      _base(size: 11, weight: FontWeight.w500, color: AppColors.textHint);

  // Form labels
  static TextStyle get label =>
      _base(size: 14, weight: FontWeight.w500, color: AppColors.textPrimary);
  static TextStyle get inputText =>
      _base(size: 14, weight: FontWeight.w400, color: AppColors.textPrimary);
  static TextStyle get inputHint =>
      _base(size: 14, weight: FontWeight.w400, color: AppColors.textHint);

  // Notification styles
  static TextStyle get notificationTitle =>
      _base(size: 14, weight: FontWeight.w600, color: AppColors.textPrimary);
  static TextStyle get notificationBody =>
      _base(size: 12, weight: FontWeight.w400, color: AppColors.textSecondary);
  static TextStyle get notificationTime =>
      _base(size: 11, weight: FontWeight.w400, color: AppColors.textHint);
  ...
  static TextStyle get caption =>
      _base(size: 10, weight: FontWeight.w400, color: AppColors.textHint);
}
